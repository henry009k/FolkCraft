...
public class ExplosiveArrowItem extends FolkcraftModElements.ModElement {
	@ObjectHolder("folkcraft:explosive_arrow")
	public static final Item block = null;
	public ExplosiveArrowItem(FolkcraftModElements instance) {
		super(instance, 2);
	}
